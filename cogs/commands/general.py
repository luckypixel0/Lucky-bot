...
class General(commands.Cog):
  ...
  @commands.command(name="users", help="checks total users of Lucky Bot.")
  @blacklist_check()
  @ignore_check()
  @commands.cooldown(1, 3, commands.BucketType.user)
  ...
  async def invite(self, ctx: commands.Context):
      embed = discord.Embed(
          title="🔮 Lucky Bot Integration Hub!",
      ...
      embed.add_field(
          name="🔮 Quick Actions",
          value=(
              f">>> **[Invite Lucky Bot](https://discord.com/oauth2/authorize?client_id={os.getenv('CLIENT_ID', '1396114795102470196')}&permissions=8&integration_type=0&scope=bot+applications.commands)**\n"
              f"**[Support Server](https://discord.gg/q2DdzFxheA)**"
          ),
          inline=False
      )
      embed.set_footer(
