...
class NoPrefix(commands.Cog):
            ...
            if expired_users:
                ...
                for user_id in expired_users:
                    ...
                    if user:
                        ...
                        embed.set_author(name="No Prefix Expired", icon_url=user.display_avatar.url if user.avatar else user.default_avatar.url)
                        
                        embed.set_footer(text="lucky X  - No Prefix, Join support to regain access.")
                        support = Button(label='Support',
                    style=discord.ButtonStyle.link,
                    url=f'https://discord.gg/q2DdzFxheA')
                        view = View()
    ...
    async def np_add(self, ctx, user: discord.User):
        ...
        embed = discord.Embed(title="Select No Prefix Duration", description="**Choose the duration for how long no-prefix should be enabled for this user:**", color=0x5865F2)
    ...
    async def add_np(self, user, duration):
        ...
        embed = discord.Embed(
                            ...
                            description=f"You've been credited 2 months of global No Prefix for boosting our Partnered Servers. You can now use my commands without prefix. If you wish to remove it, please reach out [Support Server](https://discord.gg/q2DdzFxheA).",
                            color=0x5865F2
                        )
        try:
